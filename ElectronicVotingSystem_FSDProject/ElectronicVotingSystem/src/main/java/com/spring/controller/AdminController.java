...
public class AdminController {
	...
	@PostMapping(value="/candidate/{electionid}", produces=MediaType.APPLICATION_JSON_VALUE, consumes=MediaType.APPLICATION_JSON_VALUE)
	public Object addCandidateDetails(@RequestBody Candidate candidate, CandidateEntity candidateEntity, @RequestHeader(name = "sessionId") String sessionId,
			@PathVariable(value="electionid") String electionid) {
		BeanUtils.copyProperties(candidate, candidateEntity);
		return adminService.addCandidate(candidateEntity,sessionId, electionid);
	}

	@GetMapping(value="/candidate/{electionid}", produces=MediaType.APPLICATION_JSON_VALUE, consumes=MediaType.APPLICATION_JSON_VALUE)
	public Object getCandidateDetails(@RequestHeader(name = "sessionId") String sessionId,@PathVariable(value="electionid") String electionid) {
		return adminService.getCandidateDetails(sessionId,electionid);
	}
